...
class BNO055
{
  ...
  private:
    ...
    void setExternalCrystalUse(bool state);
  ...
  public:
    ...
    void reset(void);
	  ...
	  //set mode
    void setOperationMode(bno055_opmode_t mode);
    void setOperationModeConfig(void);
    void setOperationModeNDOF(void);
    void setCalibrationData(bno055_calibration_data_t calData);
    void setAxisMap(bno055_axis_map_t axis);

	  //get status
    bno055_opmode_t getOperationMode(void);
    uint8_t getBootloaderRevision(void);
    uint8_t getSystemStatus(void);
    uint8_t getSystemError(void);
    int16_t getSWRevision(void);
    bno055_self_test_result_t getSelfTestResult(void);
    bno055_calibration_state_t getCalibrationState(void);
    bno055_calibration_data_t getCalibrationData(void);

	  //get data
    bno055_vector_t getVectorAccelerometer(void);
    bno055_vector_t getVectorMagnetometer(void);
    bno055_vector_t getVectorGyroscope(void);
    bno055_vector_t getVectorEuler(void);
    bno055_vector_t getVectorLinearAccel(void);
