...
{  
    ...
    while(1){
        ...
        {
            case BUTTON_UP: red_led.pulsewidth_us(duty_cycle = limiter(1875, 900, duty_cycle + 100)); break;
            case BUTTON_DOWN: red_led.pulsewidth_us(duty_cycle = limiter(1875, 900, duty_cycle - 100)); break;  
