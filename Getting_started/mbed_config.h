...
#define CLOCK_SOURCE                                                          USE_PLL_MSI                                                                                      // set by target:DISCO_L476VG
#define LPTICKER_DELAY_TICKS                                                  4                                                                                                // set by target:DISCO_L476VG
...
#define MBED_CONF_QSPIF_QSPI_FREQ                                             80000000                                                                                         // set by library:qspif[DISCO_L476VG]
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:DISCO_L476VG
